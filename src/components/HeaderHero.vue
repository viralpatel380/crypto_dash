      ...
      <div class="container">
        <div class="nav-left">
          <router-link to="/" class="nav-item" :class="{'hide': isOpenedInIFrame}">
            <img src="/static/app-logo.png" class="app-logo" /> <p class="app-logo-name">Crypto<span>Dash</span></p>
          </router-link>
        </div>
        ...
        <div class="modal-card">
          ...
          <section class="modal-card-body">
            <div class="content">
              ...
              <p><a target="_blank">CryptoDash</a> is a real-time dashboard that displays the top 10 cryptocurrencies based on currency price, market capitalization and overall circulating supply - obtained from the leading cryptocurrency resource <a href="https://coinmarketcap.com/" target="_blank">CoinMarketCap</a>.</p>
              <h3>Vue</h3>
              ...
              <p style="padding-bottom: 10px">Styling of the application was done with <a href="http://bulma.io/" target="_blank">Bulma</a> (Flexbox based CSS framework) and SASS. Head over to the my <a href="https://github.com/viralpatel380/crypto_dash" target="_blank">github page</a> to see the entire scaffold and feel free to reach out with any comments/questions!</p>
            </div>
          </section>
          <footer class="modal-card-foot">
            <div class="content has-text-centered">
              <div class="footer-title">Viral Patel | <icon name="calendar" height="12"></icon> 2018</div>
              <div class="footer-social-media">
               <!--  <a class="icon" href="http://hassandjirdeh.com" target="_blank">
                  <icon name="h-square" scale="2"></icon>
                </a> -->
                <a class="icon" href="https://github.com/viralpatel380" target="_blank">
                  <icon name="github-square" scale="2"></icon>
                </a>
                 <a class="icon" href="https://www.linkedin.com/in/viralpatel3654/" target="_blank">
                  <icon name="linkedin-square" scale="2"></icon>
                </a>
                <a class="icon" href="mailto:s.viralbp@itmvu.in" target="_blank">
